...
<div class="card-body">
    <form class="form-horizontal" action="" method="POST">
        ...
        <div class="form-group row">
            <div class="col-lg-3">
                <label class="col-from-label">Cities</label>
            </div>
        ...
        <div id="smtp">
            <div class="form-group row">
                ...
                <div class="col-md-3">
                    <label class="col-from-label">Standard Delivery Cost</label>
                </div>
                <div class="col-md-8">
                    <input type="text" class="form-control" name="MAIL_HOST" value="" placeholder="Standard Delivery Cost">
                </div>
            </div>
            ...
            <div class="form-group row">
                <input type="hidden" name="types[]" value="MAIL_PORT">
                <div class="col-md-3">
                    <label class="col-from-label">Express Delivery Cost</label>
                </div>
                <div class="col-md-8">
                    <input type="text" class="form-control" name="MAIL_PORT" value="" placeholder="Express Delivery Cost">
                </div>
            </div>     

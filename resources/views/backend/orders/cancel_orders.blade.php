        ...
        <div class="row mt-5">
            <div class="col-12">
                <div class="card" style="margin-left: 50px" >
                    <div class="card-body">
                        <div class="mb-2">
                            <h4 class="header-title">Cancel Orders List</h4>
                        </div>
                ...
                <div class="row"><div class="col-sm-12 "><table id="datatable-buttons" 
                    class="table table-striped dt-responsive nowrap w-100 dataTable no-footer dtr-inline" 
                    role="grid" aria-describedby="datatable-buttons_info" style="width: 1581px;">
                            <thead>
                                <tr role="row">

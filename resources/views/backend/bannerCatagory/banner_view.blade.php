    ...
    <div class="content-page" style="margin:-30px 0px 0px 0px" >
                                ...
                                <div class="row">
                                    ...
                                    <tbody>
                                     ...
                                     <tr>
                                        ...
                                        <td>
                                            <img src="{{asset($bennar_category->bennar_img)}}" width="200px;" height="100px;">
                                        </td>
                                        ...
                                        <td>
                                         ...
                                         <a href="{{route('role.bannerCategory.deactive',[config('fortify.guard'),$bennar_category->id])}}" class="btn btn-danger"><i class="fas fa-arrow-down"></i></a>
                                         @else
                                         <a href="{{route('role.bannerCategory.active',[config('fortify.guard'),$bennar_category->id])}}" class="btn btn-success"><i class="fas fa-long-arrow-alt-up"></i></a>
        ...
        <footer class="footer">
            <div class="container-fluid">
                <div class="row">
                    <div class="col-md-6">
                        <script>document.write(new Date().getFullYear())</script>2022 © Bpp Shops Admin <a href="https://excelitai.com/">Excel IT AI Team</a>
                    </div>
                    <div class="col-md-6">

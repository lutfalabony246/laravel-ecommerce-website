...
@section('main-content')
                                        ...
                                        <div class="col-10">
                                            <select class="form-control select2 customer_id" id="add__new_customer">
                                                ...
                                                @foreach ($customers as $item)
                                                    <option value="{{ $item->id }}">{{ $item->customer_id }}-
                            ...
                            <div class="card-header">
                                <div class="input-group col-12 d-flex">
                                    ...
                                    <input type="hidden" id="vat" class="vat"
                                        value="{{ Config::get('cart.tax') }}">
                                    {{-- end global tax --}}
                                    <div onclick="refreshCategory()" class="col-2">
                                        <span class="input-group-text pointer input-grp-bg"
                                            style="height: 100%; border-radius: 0px;  padding: 0px;">
                            ...
                            <div class="card-header">
                                <div class="input-group col-12 d-flex">
                                    ...
                                    <input type="hidden" id="vat" class="vat"
                                        value="{{ Config::get('cart.tax') }}">
                                    {{-- end global tax --}}
                                    <div style=" margin-left:2px;" class="col-2">
                                        <div onclick="refreshBrand()" class="col-2">
                                            <span class="input-group-text pointer input-grp-bg"
                                                style="height: 100%; border-radius: 0px;  padding: 0px;">
                                                <i class="fa-solid fa-arrows-rotate" style="margin: auto; "></i>
                                            </span>
                            ...
                            <tbody id="category_item">
                                @foreach ($products as $item)
                                    <tr onclick="AddProduct({{ $item->id }})">
                                        <td> <img
                                                src="{{ url(isset($item->product_thambnail) ? $item->product_thambnail : 'null') }}"
                                                alt="" class="img-fluid table-img">
                    ...
                    <div class="container pt-3 cashpaid-option detaile" for="inlineRadio1">
                        <div class="col-md-6">
                            <div class="input-group" id="cash">
                                ...
                                <input type="text" onkeyup="cashPaid()" id="cashPaid" class="form-control text-center"
                                    placeholder="0.00 TK">
                            </div>
                        </div>
                    </div>
                    ...
                    success: function(data) {
                        ...
                        $.each(data, function(key, value) {
                            ...
                            let s = `<tr>
                                ...
                                <td><input type="text" class="form-control" value=" &#2547 ${value.product_price?value.product_price:0}" readonly></td> 
                                <td><input type="text" class="form-control" value="&#2547 ${value.discount_price?value.discount_price:0}" readonly></td>

                                <td><input type="text" class="form-control" value=" &#2547 ${value.sub_total?value.sub_total:0}" readonly></td>
                                <td><input type="text" class="form-control" value="+ &#2547 ${value.vat?value.vat:0}" readonly></td>
                                <td><input type="text" class="form-control" value="&#2547 ${grand_total?grand_total:0}" readonly></td>
    ...
    `;
                ...
                $.ajax({
                    ...
                    success: function(data) {
                        ...
                        $.each(data, function(index, item) {
                            ...
                            s += ` <tr onclick="AddProduct(${ item.id })">
                                        <td> <img src="{{ asset('${item.product_thambnail}')}}" alt="" class="img-fluid table-img">  
                                        <td style="width: 150px;"> ${item.product_name}</td>
                                        <td>${item.product_qty} </td>
                                        <td>${item.unit} </td>
        ...
        <script>
            ...
            //         var test = document.getElementById('posShow');

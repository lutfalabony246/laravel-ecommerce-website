                        ...
                        <div class="card-body">
                            <div class="d-flex justify-content-between mb-2">
                                ...
                                <button data-bs-toggle="modal" data-bs-target="#add-slider-modal" type="button"
                                    class="btn btn-danger waves-effect waves-light mb-2 me-2" id="addSliderbtn"><i
            ...
            <div class="modal-dialog modal-dialog-centered">
                <div class="modal-content">
                    ...
                    <div class="modal-footer">
                        ...
                        <button type="submit" id="submitData" class="btn btn-success waves-effect waves-light mb-2 me-2">Add
                            Slider</button>
                    </div>
                    </form>
                </div>
            ...
            <div class="modal-dialog modal-dialog-centered">
                <div class="modal-content">
                    ...
                    <div class="modal-footer">
                        <button type="button" class="btn btn-danger waves-effect waves-light mb-2 me-2"
                            data-bs-dismiss="modal">Close</button>
                        <button type="submit" id="updateSlider" class="btn btn-primary">Update</button>
                    </div>
                    </form>
                </div>
            </div>
                ...
                $.ajax({
                    ...
                    success: function(response) {
                        ...
                        $.each(response.data, function(key, data) {
                            ...
                            <tr>
                            <td>${a++}</td>
                            <td><img src="/${data.slider_img}" height="50" width="50"></td>
                            <td>${data.title}</td>

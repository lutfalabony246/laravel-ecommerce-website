        ...
        <div class="row mt-4">
            <div class="col-xl-4">
                <div class="card">
                    ...
                    <div class="card-body">
                        <form method="post" action="{{ route('role.sale-search-by-date', config('fortify.guard')) }}">
                            @csrf
            ...
            <div class="col-xl-4">
                <div class="card">
                    ...
                    <div class="card-body">
                        <form method="post" action="{{ route('role.sale-search-by-month', config('fortify.guard')) }}">
                            @csrf
                            <div class="form-group">
            ...
            <div class="col-xl-4">
                <div class="card">
                    ...
                    <div class="card-body">
                        <form method="post" action="{{ route('role.sale-search-by-year', config('fortify.guard')) }}">
                            @csrf
                            <div class="form-group">
                                <h5>Select Year <span class="text-danger">*</span></h5>
                                <div class="controls">

        ...
        <div class="row mt-4">
            <div class="col-xl-4">
                <div class="card">
                    ...
                    <div class="card-body">
                            <form method="post" action="{{ route('role.profit.day',config('fortify.guard')) }}" >
                                @csrf
            ...
            <div class="col-xl-4">
                <div class="card">
                    ...
                    <div class="card-body">
                        <form method="post" action="{{ route('role.profit.month',config('fortify.guard')) }}">
                        @csrf
                            <div class="form-group">
            ...
            <div class="col-xl-4">
                <div class="card">
                    ...
                    <div class="card-body">
                    <form method="post" action="{{ route('role.profit.year',config('fortify.guard')) }}" >
                    @csrf
                    <div class="form-group">
                        <h5>Select Year  <span class="text-danger">*</span></h5>
                        <div class="controls">

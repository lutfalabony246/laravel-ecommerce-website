                                ...
                                <div class="row">
                                    ...
                                    <label class="mb-1">Product Name</label>
                                        ...
                                        <select id="productt" name="product_name"
                                            ...
                                            @foreach ($supplier as $purchase_productt)
...
<br><br>
                                 ...
                                 <div class="col-lg-4">
                                    ...
                                    <div class="col-lg-4">
                                        <label class="mb-1">Discount End
                                            Date</label>
                                            <input type="text" id="basic2-datepicker" class="form-control"
                ...
                <input type="submit" class="btn btn-rounded btn-success mb-5 " value="Add Product">
            </form>
            <!-- form end -->
        </div> <!-- container -->

...
<body>
    ...
    <div style="">
        <div class="pos-receipt main" style="width: 500px; margin: auto;">
            <!-- ----------  Receipt Header ------------- -->
            <div class="header">
                <h4 class="mb-3px" style="text-align:center; ">{{ $info->company_name }}</h4>
                <p style="text-align:center; margin: 3px;">{{ $info->company_address }}</p>
                <p style="text-align:center; margin: 3px; ">Office Phone: {{ $info->phone_one }}</p>
                <p style="text-align:center; margin: 3px;">BIN: {{ $info->phone_two }}</p>
                <p style="text-align:center; margin: 3px;">E-mail: {{ $info->email }}</p>
                <p style="text-align:center; margin: 3px;">Mushak-6.3</p>
            </div>


            <div style="text-align: center;margin: 3px;">
                <pre>  -----{{ $info->company_name }} Cash Memo-----</pre>
...
@endphp
            ...
            <div class="total">
                <table style="width: 100%">
                    <tr>
                        ...
                        <td  style="text-align: right;">{{ $total_subtotal }}TK.</td>
                    </tr>
                    <tr>
            ...
            <h5 class="h5">Call For Free Home Delivery-{{ $info->phone_one }}</h5>
            ...
            <div class="footer">
                ...
                <p class="text-center" style="text-align:center; margin: 3px;" >Share Your Opinion at <br> {{ $info->email }} <br>*244578*</p><br>

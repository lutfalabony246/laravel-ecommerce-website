            ...
            <div class="groceryLoginPage" style="width: 400px;">
                <div class="p-4">
                    ...
                    <form method="POST" action="{{ route('loginWithOtp') }}">
                        ...
                        <div id="sent-phone-code-wrapper2" class="d-none">
                            ...
                            <div class="pinCodeButton">
                               <button>ENTER</button>
                                <div class="timer-inner d-flex align-items-center flex-column">
                                    <div>Time left = <span id="timer"></span></div>
                                    <button type="button" class="d-none" id="requestForPin" onclick="sentCodeInPhone2()">REQUEST PIN AGAIN</button>
                    ...
                    <div class="footer py-4">
                        <p>This site is protected by reCAPTCHA and the Google <span><a href="{{ route('info.privacy')}}">Privacy
                                    Policy</a></span> and <span><a href="{{ route('info.terms')}}">Terms of Service</a></span> apply.
                        </p>
                    </div>
                </div>
            </div>

...
text/x-generic login.blade.php ( ASCII C program text )
                ...
                <div class="p-4">
                    ...
                    <form method="POST" action="{{ route('loginWithOtp') }}">
                            ...
                            <div class="phoneContainer">
                                ...
                                <div class="phoneNumberContainer">
                                    ...
                                    <div class="number" id="number2">
                                        <input id="mobile_page" onclick="showText2()" type="text" value="+88">
                                    </div>
                                </div>
                        ...
                        <div id="sent-phone-code-wrapper2" class="d-none">
                            ...
                            <div>
                                <input class="pinCodeInput" type='text' required>

...
<body>
  ...
  <table width="100%" style="background: #F7F7F7; padding:0 20px 0 20px;">
    ...
    <tr>
        <td valign="top">
            {{-- <img src="{{asset('frontend/assets/images/logo.png')}}" alt="" height="80px" width="300px"/> --}}
            <img src={{ asset( optional($setting)->logo) }} style="height:6rem !important;" alt="">
          {{-- <h2 style="color: green; font-size: 26px;"><strong>Classy Multivendor Ecommerce</strong></h2> --}}
        </td>
        <td align="right">
            <pre class="font" >
             <h3>{{ optional($setting)->company_name }}</h3>

                 {{ optional($setting)->company_address }} <br>
                 {{ optional($setting)->email }} <br>
                 {{ optional($setting)->phone_one }}
            </pre>
        </td>
    </tr>

...
<section class="profile">
    <div class="container">
        <div class="row profile-wrapper">
            <div class="col-lg-12" style="padding: 100px 0px 0px 0px">
                <article class="card"  style="margin-top: 100px; margin-bottom: 30px " >
                    ...
                    <div class="card-body">
                        ...
                        <!--    <div class="step {{ $trackStatus >=1 ?'active':'' }} "> <span class="icon"> <i class="fa fa-check"></i> </span> <span class="text">Order Pending</span> </div>-->

                        <!--    <div class="step {{ $trackStatus >=2 ?'active':'' }}"> <span class="icon"> <i class="fa fa-check"></i> </span> <span class="text"> Order Confirmed</span> </div>-->

                        <!--    <div class="step {{ $trackStatus >=3 ?'active':'' }}"> <span class="icon"> <i class="fa fa-check"></i> </span> <span class="text"> Order Processing  </span> </div>-->

                        <!--    <div class="step {{ $trackStatus >=4 ?'active':'' }}"> <span class="icon"> <i class="fa fa-check"></i> </span> <span class="text">Order Picked</span> </div>-->

                        <!--    <div class="step {{ $trackStatus >=5  ?'active':'' }}"> <span class="icon"> <i class="fa fa-check"></i> </span> <span class="text">Order Shipped </span> </div>-->

                        <!--    <div class="step {{ $trackStatus >=6 ?'active':'' }}"> <span class="icon"> <i class="fa fa-check"></i> </span> <span class="text">Delivered </span> </div>-->
                        ...
                        <!--</div>-->
                            ...
                            <div  class="step {{ $trackStatus >=1 ?'active':'' }} "> <span class="icon"> <i class="fa fa-check"></i> </span> <span class="text">Order Pending <br>{{ $track->order_date }}</span> </div>

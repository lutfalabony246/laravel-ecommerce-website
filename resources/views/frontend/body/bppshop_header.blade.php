                            ...
                            <div class="header-category">
                               ...
                               <div class="bpp-header-menu">
                                <ul>                                   
                                    ...
                                    <li><a href="{{route('islamic')}}"><span><img class="img-fluid" src={{ asset('frontend/assets/images/icons/08.png')}}></span> Islamic</a></li>
                                    <li><a href="#"><span><img class="img-fluid" src={{ asset('frontend/assets/images/icons/05.png')}}></span> Fashion</a></li>
                                    <li><a href="#"><span><img class="img-fluid" src={{ asset('frontend/assets/images/icons/02.png')}}></span> Grocery</a></li>
                  ...
                  <!--      </form>-->
                            ...
                            <div class="">
                                <form action="{{ route('searchproduct.view') }}"
                                    ...
                                    <div class="search d-flex">
                                        <div class="search-input">
                                            <input type="text" name="searchValue"  id="searchId" autocomplete="off">
                                        </div>
                                        <div class="search-btn d-flex align-items-center">
                                            <button type="submit" class="btn w-100"><i class="fas fa-search"></i></button>
                                        </div>
                        ...
                        <div id="icon-block" class="icon-block">
                            <ul class="wr-menu theme-color fs-5 text-white">
                                <li class="mobile-user icon-desk-none" onclick="openWishlist()">
                                    @auth
                                    <div class="dropdown">
                                    ...
                                    <div>
                                        <ul class="">
                                           ...
                                           <li>   <a class="text-white" data-bs-toggle="modal" data-bs-target="#bppShopLoginModal"
                                            href="#" style="font-weight:bold"> Login </a>
                                            </li>

          ...
          <div class="row">
             <div class="col-lg-6 col-xs-12">
                <div class="quick-view-img">
                   <img src=" {{ asset('frontend/assets/images/mega-store/product/8.jpg') }} " alt="" class="img-fluid bg-img">
                </div>
             </div>
                ...
                <div class="product-right">
                   ...
                   <div class="pro-group pb-0">
                      ...
                      <div class="product-buttons">
                         <a href="javascript:void(0)" onclick="addItemToCart()"
                            class="btn cart-btn btn-normal tooltip-top add-cartnoty"
                ...
                <div class="media">
                   <div class="img-wraper">
                      <a href="product-page(left-sidebar).html">
                         <img src=" {{ asset('frontend/assets/images/mega-store/product/9.jpg') }} " alt="" class="img-fluid">
                      </a>
                   </div>
    ...
    <div class="cart_media">
       <ul class="cart_product">
          <li>
             <div class="media">
                <a href="product-page(left-sidebar).html">
                   <img alt="megastore1" class="me-3" src=" {{ asset('frontend/assets/images/mega-store/product/1.jpg') }} ">
                </a>
                <div class="media-body">
                   <a href="product-page(left-sidebar).html">
          ...
          <li>
             <div class="media">
                <a href="product-page(left-sidebar).html">
                   <img alt="megastore1" class="me-3" src=" {{ asset('frontend/assets/images/mega-store/product/2.jpg') }} ">
                </a>
                <div class="media-body">
                   <a href="product-page(left-sidebar).html">
          ...
          <li>
             <div class="media">
                <a href="product-page(left-sidebar).html">
                   <img alt="megastore1" class="me-3" src=" {{ asset('frontend/assets/images/mega-store/product/3.jpg') }} ">
                </a>
                <div class="media-body">
                   <a href="product-page(left-sidebar).html">
...
{{-- <div id="cart-float-button" class="cart-float-main" onclick="openCart()">
 <!-- <a href="#"> -->
 <div class="cart-icon">
